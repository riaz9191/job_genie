...
const JobCategory = () => {
  ...
  useEffect(() => {
    fetch(
      "https://raw.githubusercontent.com/Porgramming-Hero-web-course/b7a9-career-hub-riaz9191/main/public/categoryData.json?token=GHSAT0AAAAAACAN3SO3RWBLHWL7FT4DJUPOZBVM7ZA"
    ) 
      .then((res) => res.json())
