...
const MainDetails = () => {
  const handleAddJob = (obj) => {
    ...
    if (prevApplied.some((job) => job.id === obj.id)) {
  ...
  return (
    <div className="my-container">
      <div>
        <h1 className="text-center mt-8 md:mt-24 font-bold text-4xl ">
          Job Details
        </h1>
      </div>
      <div className="flex flex-col md:flex-row md:gap-5 mt-10 md:mt-40">
        ...
        <div className="mt-10 md:mt-0">
          <div className="bg-purple-200 bg-opacity-25 p-8 md:ml-12 md:mr-16 md:pr-20">
          ...
          <div className="ml-12 mt-5 pr-20 justify-end">
            <button
              onClick={() => handleAddJob(details)}
              className="text-xl w-full st pl-4 pr-4 pt-2 pb-2 text-white rounded-xl"
            >
              Apply Now
            </button>
          </div>
